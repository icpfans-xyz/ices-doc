...
# Motoko Tutorial
------
CES's Mainnet canister: * **ark2z-fiaaa-aaaah-aa4ta-cai** *  
In your **Motoko** conract code, follow the steps below.  


## 1. Build and initialize the CES actor
...
## 2. Call the CES Canister emit method to send log data.
...
* Send the specified view of login user data related, specify eventKey = "CES_USER"
...
* Send general custom data, and then you can query related data and charts through the services provided by CES
